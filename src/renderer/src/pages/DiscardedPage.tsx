...
import { ArchiveX, Search, Trash2 } from "lucide-react";
  ...
  return (
    <div className="min-h-screen ">
      ...
      <div className="pt-6  p-10">
        ...
        {listings.length === 0 && !isLoading && <IconTextPage heading="No discarded listings" description="You don't have any listings discarded" icon={ArchiveX} />}
      </div>
    </div>
  );
}
